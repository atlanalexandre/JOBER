    ...
    cgps: {
      ...
      sections:[
        ...
        },
        {
          ...
          text:"5.1 Publication d'une Prestation\nLe Client publie une Prestation sur la Plateforme en renseignant le secteur d'activité, le métier recherché, la date, la durée estimée, le lieu d'intervention et le tarif horaire proposé. La Prestation est alors rendue visible aux Prestataires correspondant au profil recherché.\n\n5.2 Affectation des Prestataires\nLorsque la Prestation est exécutée directement pour le Client et dans ses propres locaux, le Client peut librement consulter les profils disponibles et sélectionner le Prestataire de son choix, ou recevoir les candidatures des Prestataires intéressés et retenir celle qui lui convient.\n\nEn revanche, lorsque le Client déclare que la Prestation sera exécutée au bénéfice, pour le compte ou dans les locaux d'un tiers au sens de l'article 10B, le Client décrit son besoin, les compétences requises, la période d'intervention et les caractéristiques de la mission. Dans cette hypothèse, ALANE procède à l'affectation du Prestataire parmi les professionnels disponibles répondant aux critères objectifs de la mission. Le Client ne peut exiger l'intervention d'un Prestataire nommément désigné ni conditionner sa commande à l'identité d'une personne déterminée.\n\nL'affectation réalisée par ALANE ne constitue pas un pouvoir de direction sur le Prestataire mais une modalité technique d'organisation de la mise en relation, destinée à prévenir tout risque de fourniture de personnel ou de mise à disposition de main-d'œuvre. Le refus d'une affectation par le Client demeure possible avant confirmation définitive de la commande.\n\nDans tous les cas, chaque Prestataire est libre d'accepter ou de refuser toute Prestation proposée, sans avoir à se justifier et sans pénalité. L'acceptation vaut conclusion du Contrat de prestation entre le Client et le Prestataire, auquel ALANE n'est pas partie.\n\n5.3 Confirmation et paiement\nDès l'acceptation d'une proposition, le Client procède au paiement sécurisé via Stripe. Les fonds sont sécurisés par Stripe Connect jusqu'à la validation de la Prestation. Le Prestataire reçoit une confirmation de la Prestation et les informations nécessaires à son exécution.\n\n5.4 Exécution et validation\nÀ l'issue de la Prestation, le Prestataire et le Client valident mutuellement la bonne exécution de la prestation via la Plateforme. La double validation déclenche le versement de la rémunération au Prestataire. À défaut de validation par le Client dans un délai de 72 heures ouvrées après la fin de la Prestation, celle-ci est réputée validée et les fonds sont automatiquement libérés au Prestataire."
        },
        {
