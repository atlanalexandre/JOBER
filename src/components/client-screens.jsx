    ...
    cgps: {
      ...
      sections:[
        ...
        },
        {
          ...
          text:"14.1 Responsable de traitement\nLes données personnelles collectées et traitées dans le cadre de l'utilisation de la Plateforme sont traitées par ALANE en qualité de responsable de traitement, conformément au Règlement Général sur la Protection des Données (RGPD — Règlement UE 2016/679) et à la loi Informatique et Libertés modifiée.\n\n14.2 Données collectées\nALANE collecte et traite les données nécessaires à la fourniture de ses services : données d'identité, coordonnées, documents professionnels (SIRET, pièce d'identité, Kbis), données bancaires (IBAN — uniquement pour les versements, traitement délégué à Stripe), historique des Missions et évaluations, données de connexion et de navigation.\n\n14.3 Finalités du traitement\nCes données sont traitées pour : la gestion des comptes utilisateurs et la vérification de l'identité et des qualifications, la mise en relation entre Clients et Prestataires, le traitement des paiements via Stripe, la communication transactionnelle, la prévention de la fraude, l'amélioration des services de la Plateforme et le respect des obligations légales.\n\n14.4 Droits des utilisateurs\nConformément au RGPD, tout utilisateur dispose d'un droit d'accès, de rectification, d'effacement, de limitation et de portabilité de ses données, ainsi que d'un droit d'opposition. Ces droits peuvent être exercés en contactant ALANE à l'adresse direction@alane.fr. Pour une description complète des traitements, consulter la Politique de confidentialité accessible via la Plateforme."
        },
        {
