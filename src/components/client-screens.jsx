    ...
    cgps: {
      ...
      sections:[
        ...
        },
        {
          ...
          text:"5.1 Publication d'une Mission\nLe Client publie une Mission sur la Plateforme en renseignant le secteur d'activité, le métier recherché, la date, la durée estimée, le lieu d'intervention et le tarif horaire proposé. La Mission est alors rendue visible aux Prestataires correspondant au profil recherché.\n\n5.2 Candidature et acceptation\nLes Prestataires intéressés peuvent postuler à une Mission. Chaque Prestataire est libre de postuler ou non à chaque Mission proposée, et peut refuser toute Mission sans avoir à se justifier et sans pénalité. Le Client reçoit les candidatures et sélectionne le Prestataire de son choix. L'acceptation d'une candidature par le Client vaut conclusion du Contrat de prestation entre les deux parties. ALANE n'intervient pas dans ce choix et n'est pas partie au contrat ainsi formé.\n\n5.3 Confirmation et paiement\nDès l'acceptation d'une candidature, le Client procède au paiement sécurisé via Stripe. Les fonds sont sécurisés par Stripe Connect jusqu'à la validation de la Mission. Le Prestataire reçoit une confirmation de la Mission et les informations nécessaires à son exécution.\n\n5.4 Exécution et validation\nÀ l'issue de la Mission, le Prestataire et le Client valident mutuellement la bonne exécution de la prestation via la Plateforme. La double validation déclenche le versement de la rémunération au Prestataire. À défaut de validation par le Client dans un délai de 72 heures ouvrées après la fin de la Mission, celle-ci est réputée validée et les fonds sont automatiquement libérés au Prestataire."
        },
        {
          title:"Article 5B — Programme de parrainage et cashback",
          text:"ALANE propose à ses Clients un programme de fidélité sous forme de cashback sur les Missions réalisées via la Plateforme.\n\n5B.1 Cashback sur les Missions\nLe Client bénéficie d'un retour en crédit ALANE calculé sur le montant net des prestations validées, selon les paliers suivants :\n• 0,5 % du montant net de la prestation pour les Clients ayant validé moins de 10 missions\n• 1 % du montant net de la prestation pour les Clients ayant validé entre 10 et 29 missions\n• 1,5 % du montant net de la prestation pour les Clients ayant validé 30 missions ou plus\n\nLe crédit cashback est crédité sur le solde du compte ALANE du Client dans un délai de 48 heures ouvrées suivant la validation de la Mission. Ce crédit est utilisable pour le paiement total ou partiel de futures Missions sur la Plateforme.\n\n5B.2 Programme de parrainage\nTout utilisateur inscrit sur la Plateforme peut parrainer de nouveaux utilisateurs en partageant son lien ou code de parrainage. Les conditions et avantages du programme de parrainage sont précisés dans la section dédiée de la Plateforme et peuvent être modifiés à tout moment par ALANE.\n\n5B.3 Conditions générales\nLe cashback et les avantages de parrainage ne sont pas convertibles en espèces, ne sont pas cessibles et ne peuvent pas faire l'objet d'un remboursement en cas de résiliation du compte. ALANE se réserve le droit de modifier ou de supprimer ce programme à tout moment, sous réserve d'un préavis raisonnable communiqué via la Plateforme."
        },
        {
...
export function DocUploadScreen({ onBack }) {
  ...
  const handleFileChange = async (docId, e) => {
    ...
    try {
      ...
      // Synchroniser le SDK avec le token valide
