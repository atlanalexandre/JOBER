...
Signé électroniquement le ${new Date().toLocaleDateString("fr-FR")}`}
      ...
      <div style={{ padding:"22px 18px" }}>
        ...
        {step===3 && <>
          ...
          {/* Le bouton « Vers mon portefeuille » a été retiré le 16/08/2026 : il
              versait le cashback dans le solde rechargé, où il devenait
              indiscernable de l'argent du client. Le transfert n'a plus d'objet —
              le cashback est utilisé automatiquement, et en premier. */}
