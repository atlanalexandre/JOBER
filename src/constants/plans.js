...
export const ABONNEMENTS_PRESTA = [
  ...
  { id:"free",    label:"Gratuit", price:0,  color:"#8B8FA8", icon:"🆓", missions:2,  popular:false,
    ...
    locked:["10 prestations/mois","Badge ✓ Certifié — les clients te font davantage confiance","Priorité dans les résultats de recherche"],
  ...
  { id:"premium", label:"Premium", price:29.99, color:"#7C6FE0", icon:"💎", missions:10, popular:true,
    features:["10 prestations/mois","Badge ✓ Certifié affiché sur ton profil — visible par tous les clients"],
